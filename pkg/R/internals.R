...
read.hyman <- function (chrs = 1:22) {
  ...
  # Raw log ratios
  #cdna <- as.matrix(read.csv("/share/mi/data/pint10/Hyman2002/HymancdnaLRatios.tab", sep = " ", header = FALSE))
  #cgh <- as.matrix(read.csv("/share/mi/data/pint10/Hyman2002/HymancghRatios.tab", sep = " ", header = FALSE))
