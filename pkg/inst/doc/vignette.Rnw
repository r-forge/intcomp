...
test_ferrari <- test.simulation(GE_data, CN_data, method="ferrari", n=100)
@
...
res <- test.geneorder.pipeline(ge = ge, cn.raw = cn.raw, cn.seg = cn.seg, cn.call = cn.call, cghCall = cgh, Labels = NULL, cancerGenes = cancerGenes, nperm=20, input = "real", version = "normal", methods = methods)
...
cn.call=test_schaefer$cn.call, cghCall = test_schaefer$cn.cghCall, ge.norm = test_schaefer$ge.norm, cn.norm = test_schaefer$cn.norm, Labels=test_schaefer$Labels, cancerGenes=test_schaefer$cancerGenes, nperm = 1000, input="simulations.equal.dimensions", version = "normal", methods=methods, callprobs=sim$callprobs)
@
