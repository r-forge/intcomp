...
\Rpackage{intcomp} benchmarking pipeline: {\it OrtizEstevez}, {\it
intcngean}, {\it edira}, {\it pint}, {\it SIM.window\}, {\it
SIM.full\}, {\it DRI.cp}, {\it DRI.cs}, {\it PMA.raw}, {\it CNAmet},
{\it PREDA} and for two-group comparisons (requiring Labels) {\it
